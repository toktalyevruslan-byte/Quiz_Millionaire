...
class DataManager:
    def __init__(self, stats_file: str = "records.json", profile_file: str = "profile.json", settings_file: str = "settings.json"):
        ...
        self.stats_file = os.path.join(self.BASE_DIR, stats_file)
        self.profile_file = os.path.join(self.BASE_DIR, profile_file)
    ...
    def get_achievements_data(self) -> Dict[str, any]:
        ...
        ach_path = os.path.join(self.BASE_DIR, "achievements.json")
